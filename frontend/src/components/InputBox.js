...
export default function InputBox({ lengthOfMessages }) {
    ...
    return <form onSubmit={handleFormSubmit} className={`${lengthOfMessages > 0 && "fixed bottom-10 w-2/3 max-w-3xl"} bg-foreground overflow-hidden px-3 pl-7 py-3 w-1/2 flex justify-between items-center rounded-3xl`}>
